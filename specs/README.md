...
| 067 | `067-the-party-page.md` | Phase 3 QoL — the party page as a party sheet: standing and stars it had no access to, plus per-zone coverage and who claimed what, so the union scoring rule stops being invisible | **done** |
...
- **067–070** — The party page, the event's ending, an activity ticker and settings. **Done.**
