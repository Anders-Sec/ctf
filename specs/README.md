...
| 062 | `062-challenge-board.md` | Phase 3 QoL — the challenge list becomes the board: sticky zone sidebar, one row per challenge, stable authored ordering, sealed zones collapsed and sealed titles withheld server-side, and the challenge opens as an overlay so solving never costs your place | **approved** (2026-09-18) |
...
- **062** — The challenge board. **Approved**, in build.
