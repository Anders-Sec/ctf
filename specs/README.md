...
| 061 | `061-public-character-sheet.md` | Phase 3 QoL — somebody else's sheet, mirroring 060 without XP or loot: secrets blurred server-side, achievements as a trophy case, and a Feats block of stars, counters and a zone breakdown | **draft** |
...
- **061** — Somebody else's character sheet. **Drafted**, awaiting sign-off.
