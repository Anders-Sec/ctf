...
| 065 | `065-the-inbox.md` | Phase 3 QoL — notifications become an inbox: Yours and Event tabs, a kind filter, soft-dismiss clearing, colour with the kind named, and toasts that are quieter, shorter and unclickable | **approved** (2026-09-18) |
...
- **065** — The inbox. **Approved**, in build.
